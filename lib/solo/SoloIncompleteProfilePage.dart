import 'package:citicare/solo/solo_application_form.dart';
import 'package:flutter/material.dart';

class SoloIncompleteProfilePage extends StatelessWidget {
  const SoloIncompleteProfilePage({super.key});
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const SoloApplicationForm()),
                    );
                  },
