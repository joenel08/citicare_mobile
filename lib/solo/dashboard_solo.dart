...
import 'package:citicare/solo/QR_code_generator.dart';
import 'package:citicare/solo/id_card_generator.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'sidebar_solo.dart';
...
class _SoloDashboardState extends State<SoloDashboard> {
  ...
  Future<void> _fetchProfileData() async {
    ...
    try {
      ...
      Uri seniorInfoUri = buildUri('get_solo_info_for_id.php', {
        'user_id': userId,
      });
