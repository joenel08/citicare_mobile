import 'package:citicare/pwd/pwd_application_form.dart';
import 'package:flutter/material.dart';

class PWDIncompleteProfilePage extends StatelessWidget {
  const PWDIncompleteProfilePage({super.key});
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const PwdApplicationForm()),
                    );
                  },
