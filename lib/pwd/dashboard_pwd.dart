...
import 'package:citicare/pwd/sidebar_pwd.dart';
...
class PWDDashboard extends StatefulWidget {
  final int userId;
  ...
  @override
  State<PWDDashboard> createState() => _PWDDashboardState();
}

class _PWDDashboardState extends State<PWDDashboard> {
  ...
  Future<void> _fetchProfileData() async {
    ...
    try {
      Uri seniorInfoUri = buildUri('users/get_pwd_info_for_id.php', {
        'user_id': userId,
      });
